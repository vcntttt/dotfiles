...
abbr --add al 'nvim "$HOME/dotfiles/shell-common/.config/fish/aliases.fish"; source "$HOME/.config/fish/config.fish"'
abbr --add lal 'bat "$HOME/dotfiles/shell-common/.config/fish/aliases.fish"'
...
abbr --add ee 'nvim ~/dotfiles/common/.config/espanso/match/base.yml; espanso restart'
abbr --add lee 'cat ~/dotfiles/common/.config/espanso/match/base.yml'
