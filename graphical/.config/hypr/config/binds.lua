...
hl.bind("Print",               hl.dsp.exec_cmd("/home/vrivera/.local/bin/screenshot-region copy"))
-- Captura un área y abre Satty para editar, copiar o guardar.
hl.bind(mainMod .. " + Print", hl.dsp.exec_cmd("/home/vrivera/.local/bin/screenshot-region edit"))
-- Selecciona una ventana completa y la abre en Satty.
hl.bind(mainMod .. " + SHIFT + Print", hl.dsp.exec_cmd("/home/vrivera/.local/bin/screenshot-window-edit"))
